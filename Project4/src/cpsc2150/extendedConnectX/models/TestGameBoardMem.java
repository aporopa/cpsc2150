...
public class TestGameBoardMem {
    private IGameBoard TestingGameBoardMem(int rows, int columns, int numToWin){
    ...
    public void testingConstructor_min(){
        ...
        IGameBoard gb = this.TestingGameBoardMem(minRow,minColumn,minToWin);
    ...
    public void testingConstructor_max(){
        ...
        IGameBoard gb = this.TestingGameBoardMem(maxRow,maxColumn,maxToWin);
    ...
    public void testingConstructor_abstract(){
        ...
        IGameBoard gb = this.TestingGameBoardMem(Row,Column,ToWin);
    ...
    public void testingCheckIfFree_full(){
        ...
        IGameBoard testingBoard = new GameBoardMem(Row, Column, ToWin);
        for(int r = 0; r < Row; r++){
            for(int c = 0; c < Column; c++){
