...
*/
        ...
        //Prompt the user and parse into an integer
        ...
        while(choice != 12) {
            switch (choice) {
                ...
                //If the deque is not full
                //then inject a number at the front of the deque
                case 2:
                    if(q.length() == IDeque.MAX_LENGTH) {
                        System.out.println("Deque is full!");
                    }
                ...
                //dequeue the integer at the front
                ...
                //Allows the user to enter an integer at a specific location in the deque
                ...
                case 7:
                    if(q.length() == IDeque.MAX_LENGTH) {
                        ...
                        q.insert(userNum, userPos);
                    }
                    break;

                //Allows the user to remove an integer from the deque
